...
const showSizeForm=()=>{
    ...
    return (
        <div className='show-photo-box'> {currentPhoto ? <img id={currentPhoto.id} src={currentPhoto.url} />  : null }
                <div>
                    <Button className="grayscale-btn" variant="primary" type="button" onClick={grayscaleHendler}>Grayscale</Button>
                    <Button className="grayscale-btn" variant="primary" type="button" onClick={showSizeForm}>Change size</Button>
                </div>
                {changeSize ?
                    <div className="size-form-div">
                    ...
                    <Button className="photo-size-btn" variant="primary" type="submit" >OK</Button>
                    </Form>
                    </div>
                :null}
        </div>
